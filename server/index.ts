...
app.listen(PORT, '0.0.0.0', () => {
  ...
  // Importar db.ts DESPUÉS de que el servidor arranque para inicializar la conexión
  import('./db.js').then(() => {
    console.log('📊 Módulo de base de datos cargado e inicializado');
  }).catch(err => {
    console.error('❌ Error cargando módulo de base de datos:', err.message);
  });
});
